/**
 * SubtractPolys class can be used to subtracts two polynomials.
 * @author Aditi Datta
 */
public class SubtractPolys {
     ...
     */
    public ObjectList subtractTwoPolys(ObjectList list1, ObjectList list2){
        ...
        while(p!= null && q!= null){
            ...
            if(t1.getExpon() == t2.getExpon()){
                ...
                attach((-1)*t2.getCoeff(), t2.getExpon());
                q = q.getNext();
            }
        }
